...
-- | 
module Labs2025
    ( -- SUBSTITUIR ESTE CONTEÚDO com a lista completa:
      module Tarefa0_geral -- Manter esta exportação (que o professor deu)
    , Terreno(..)
    , Mapa
    , TipoArma(..)
    , VidaMinhoca(..)
    ...
    , NumObjeto
    , Objeto(..)
    , Estado(..)     -- <--- ESSENCIAL para o TestesT1.hs
    , Jogada(..)
    
    -- E adicionar as FUNÇÕES que o TestesT1.hs quer usar:
